	...
	<div class="col-md-12">
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<div class="page-heading"> <i class="glyphicon glyphicon-wrench"></i> My Account</div>
			</div> 
			...
			<div class="panel-body">
				...
				<form action="php_action/deleteAccount.php" method="post" class="form-horizontal" id="deleteAccountForm">
					<fieldset>
						<legend>Delete Account</legend>

						<div class="deleteAccountMessages"></div>
						...
						<div class="form-group">
					    	<div class="col-sm-offset-2 col-sm-10">
					      		<input type="hidden" name="user_id" id="user_id" value="<?php echo $result['user_id'] ?>" /> 
					      	<button type="submit" class="btn btn-danger" data-loading-text="Loading..." id="deleteAccountBtn"> <i class="glyphicon glyphicon-trash"></i> Delete Account </button>
					    </div>
					</fieldset>
					</form>
				</div>
