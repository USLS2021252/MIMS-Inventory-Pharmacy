        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li id="navBrand"><a href="brand.php"><i class="glyphicon glyphicon-globe"></i>  Brand</a></li>
                    <li id="navCategories"><a href="categories.php"> <i class="glyphicon glyphicon-th-list"></i> Category</a></li>
                    <li id="navProduct"><a href="product.php"> <i class="glyphicon glyphicon-tags"></i> Product </a></li>
                    ...
                    <li class="dropdown" id="navSetting">
                        ...
                        <ul class="dropdown-menu">
                            <li id="topNavSetting"><a href="myaccount.php"> <i class="glyphicon glyphicon-wrench"></i> My Account</a></li>
